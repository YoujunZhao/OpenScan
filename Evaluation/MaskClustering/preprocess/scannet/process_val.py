...
target_data_dir = '/home/zyj/mnt/Open3DIS/data/Scannet200/Scannet200_2D_5interval/val'
...
def process_one_seq(seq_name):
    ...
    shutil.copyfile(f'{raw_data_dir}/{seq_name}/{seq_name}_vh_clean_2.ply', f'{original_ply_dir}/{seq_name}_vh_clean_2.ply')
