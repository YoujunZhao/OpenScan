...
CLASS_LABELS_200 = (
'wall', 'chair', 'floor', 'table', 'movable barrier', 'couch', 'cabinet', 'shelf', 'desk', 'office chair', 'bed', 'pillow', 'sink', 'representation', 'window', 'toilet', 'bookshelf', 'monitor', 'curtain', 'an excellent source of information', 'armchair', 'coffee table', 'box',
