...
def evaluate(preds: dict, gt_path: str, output_file: str, dataset: str = "scannet"):
    ...
    if dataset == "scannet200":
        ...
        'refrigerator', 'lamp', 'kitchen cabinet', 'towel', 'clothes', 'using a VCR requires this term', 'nightstand', 'counter', 'dresser', 'stool', 'cushion', 'this term requires water and sun', 'ceiling', 'have a bath requires this term', 'end table', 'dining table', 'type requires this term', 'bag', 'backpack', 'toilet paper',
        'print requires this term', 'tv stand', 'whiteboard', 'blanket', 'shower curtain', 'trash can', 'closet', 'stairs', 'microwave', 'stove', 'shoe', 'computer tower', 'bottle', 'bin', 'ottoman', 'bench', 'board', 'washing machine', 'grooming requires this term', 'copier',
        'basket', 'sofa chair', 'file cabinet', 'fan', 'go on the internet requires this term', 'shower', 'paper', 'person', 'paper towel dispenser', 'oven', 'blinds', 'rack', 'plate', 'blackboard', 'piano', 'bring suit requires this term', 'rail', 'radiator', 'recycling bin', 'container',
        'wardrobe', 'soap dispenser', 'make a phone call require this term', 'bucket', 'wake up in the morning requires this term', 'stand', 'light', 'laundry basket', 'pipe', 'clothes dryer', 'playing a guitar require this term', 'toilet paper holder', 'seat', 'speaker', 'column', 'riding a bicycle requires this term', 'ladder', 'bathroom stall', 'shower wall',
