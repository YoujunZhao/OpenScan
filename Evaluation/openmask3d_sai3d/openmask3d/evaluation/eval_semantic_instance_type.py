...
def evaluate(preds: dict, gt_path: str, output_file: str, dataset: str = "scannet"):
    ...
    if dataset == "scannet200":
        ...
        CLASS_LABELS = (
        'chair', 'table', 'movable barrier', 'couch', 'cabinet', 'shelf', 'desk', 'office chair', 'bed', 'pillow', 'sink', 'representation', 'window', 'toilet', 'bookshelf', 'monitor', 'curtain', 'an excellent source of information', 'armchair', 'coffee table', 'box',
        'refrigerator', 'common ligght bulb', 'kitchen cabinet', 'piece of cloth', 'clothes', 'tv', 'nightstand', 'counter', 'dresser', 'stool', 'cushion', 'plant', 'top surface of a room', 'bathtub', 'end table', 'dining table', 'keyboard', 'bag', 'backpack', 'toilet paper',
        'printer', 'tv stand', 'whiteboard', 'bedclothes', 'shower curtain', 'trash can', 'closet', 'stairs', 'microwave', 'stove', 'shoe', 'computer tower', 'bottle', 'bin', 'ottoman', 'a long seat with no backrest', 'board', 'washing machine', 'reflector', 'copier',
        'basket', 'sofa chair', 'file cabinet', 'fan', 'portable computer', 'shower', 'paper', 'person', 'paper towel dispenser', 'oven', 'blinds', 'rack', 'plate', 'blackboard', 'piano', 'suitcase', 'rail', 'radiator', 'recycling bin', 'container',
        'wardrobe', 'soap dispenser', 'a communication device', 'bucket', 'clock', 'stand', 'light', 'laundry basket', 'pipe', 'clothes dryer', 'string instrument', 'toilet paper holder', 'seat', 'speaker', 'column', 'a two wheel vehicle', 'ladder', 'bathroom stall', 'shower wall',
        ...
        'toilet paper dispenser', 'mini fridge', 'firefighting equipment', 'a toy', 'hat', 'shaft', 'water cooler', 'cutting implement', 'tray', 'shower door', 'supporter', 'ledge', 'toaster oven', 'mouse', 'toilet seat cover dispenser',
        'furniture', 'cart', 'storage container', 'measuring instrument', 'tissue box', 'light switch', 'crate', 'power outlet', 'decoration', 'clue', 'optical device', 'closet door', 'vacuum cleaner', 'a stick of wax', 'a tool to unclog toilets', 'toy animal', 'audio device', 'dish rack',
        'broom', 'guitar case', 'hood', 'dustpan', 'beauty device', 'water bottle', 'handicap bar', 'handbag', 'vent', 'shower floor', 'water pitcher', 'a container for letters', 'bowl', 'paper bag', 'clock', 'music stand', 'projector screen', 'drafting instrument',
        'detergent', 'bathroom counter', 'object', 'bathroom vanity', 'closet wall', 'laundry hamper', 'bathroom stall door', 'ceiling light', 'trash bin', 'fitness equipment', 'stair rail', 'conduit', 'bathroom cabinet', 'cd case', 'closet rod',
        'kettle', 'structure', 'device for spraying', 'electronic piano', 'case of water bottles', 'coat rack', 'storage organizer', 'folded chair', 'alarm', 'power strip', 'time list', 'poster', 'potted plant', 'luggage', 'mattress')
