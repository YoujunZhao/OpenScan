...
CLASS_LABELS_200 = (
'wall', 'chair', 'floor', 'table', 'door', 'couch', 'cabinet', 'shelf', 'desk', 'office chair', 'bed', 'pillow', 'sink', 'an art show has this term', 'window', 'this term has urine', 'bookshelf', 'this term has screen', 'curtain', 'this term has knowledge', 'armchair', 'coffee table', 'box',
...
'coffee kettle', 'structure', 'a shower stall has this term', 'keyboard piano', 'case of water bottles', 'this term has a coat', 'storage organizer', 'folded chair', 'fire alarm', 'power strip', 'this term has each month of the year', 'poster', 'potted plant', 'luggage', 'bad has this term')
