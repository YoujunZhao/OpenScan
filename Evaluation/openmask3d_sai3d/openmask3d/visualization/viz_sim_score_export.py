...
def main():
    ...
    path_scene_pcd = '/home/zyj/mnt/openmask3d/openmask3d/data/scans' + '/' + scene_id + '/' + scene_id + '_vh_clean_2.ply'
    # path_pred_masks = "/home/zyj/mnt/openmask3d/output/2024-05-24-14-26-03-experiment/scene_example_masks.pt"
    # path_openmask3d_features = "/home/zyj/mnt/openmask3d/output/2024-05-24-14-26-03-experiment/scene_example_openmask3d_features.npy"

    # path_scene_pcd = "/home/zyj/mnt/openmask3d/openmask3d/data/scans/" + 
    path_pred_masks = "/home/zyj/mnt/openmask3d/output/2024-07-31-scannet200/masks/" + scene_id + "_masks.pt"
    path_openmask3d_features = "/home/zyj/mnt/openmask3d/output/2024-07-31-scannet200/mask_features/" + scene_id + "_openmask3d_features.npy"
    ...
    # Set the query text
    # --------------------------------
    query_text = "this term has 88 keys" # change the query text here
    ...
    o3d.io.write_point_cloud("/home/zyj/mnt/openmask3d/openmask3d/data/scene_pcd_w_sim_colors_{}.ply".format('_'.join(query_text.split(' '))), scene_pcd_w_sim_colors)
