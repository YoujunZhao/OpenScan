...
sys.path.append('/home/zyj/mnt/openmask3d/openmask3d/class_agnostic_mask_computation/datasets/preprocessing')
...
sys.path.append('/home/zyj/mnt/openmask3d/openmask3d/class_agnostic_mask_computation/datasets')
...
class ScannetPreprocessing(BasePreprocessing):
    def __init__(
            self,
            data_dir: str = "/data/fengelmann/data/scannet",
            save_dir: str = "/local/home/efedele/clean/Mask3D/data/processed/scannet",
            modes: tuple = ("train", "validation"),
            n_jobs: int = -1,
            git_repo: str = "/local/home/efedele/clean/Mask3D/data/raw/scannet/ScanNet",
        ...
        if self.scannet200:
            self.labels_pd = pd.read_csv("/home/zyj/mnt/MaskClustering/ScanNet/scannetv2-labels.combined.tsv", sep='\t', header=0)
    ...
    def process_file(self, filepath, mode):
        ...
        if mode in ["train", "validation"]:
            ...
            segments_test = "/home/zyj/mnt/MaskClustering/ScanNet/scans_test"
