...
# CLASS_LABELS_200 = (
# 'wall', 'chair', 'floor', 'table', 'door', 'couch', 'cabinet', 'shelf', 'desk', 'office chair', 'bed', 'pillow', 'sink', 'represent', 'look outside', 'poop', 'organize books', 'monitor', 'curtain', 'learning', 'armchair', 'coffee table', 'box',
