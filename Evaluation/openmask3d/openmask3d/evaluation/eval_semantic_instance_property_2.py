...
def evaluate(preds: dict, gt_path: str, output_file: str, dataset: str = "scannet"):
    ...
    if dataset == "scannet200":
        ...
        # CLASS_LABELS = ('This term is useful for camping', 'This term is soft', 'This term is opaque and closed', 'This term is essential for privacy', 'This term is helpful in making comparisons', 'This term is analog or digital', 'This term is hot', 'This term is one kind of stringed instrument', 'This term is open or closed', 'This term is horizontal', 'This term is fun to ride', 'This term is reflective', 'This term is alive', 'This term is bright', 'This term is hollow', 'This term is round', 'This term is useful for unblocking a toilet', 'This term is shaped like a shell', 'This term is convex down', 'other')
