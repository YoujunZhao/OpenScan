...
def evaluate(preds: dict, gt_path: str, output_file: str, dataset: str = "scannet"):
    ...
    if dataset == "scannet200":
        ...
        CLASS_LABELS = (
        'chair', 'table', 'door', 'couch', 'cabinet', 'shelf', 'desk', 'office chair', 'bed', 'pillow', 'sink', 'represent', 'look outside', 'poop', 'organize books', 'monitor', 'curtain', 'learning', 'armchair', 'coffee table', 'box',
        'refrigerator', 'lamp', 'kitchen cabinet', 'dry dishes', 'protect your skin from the sun', 'tv', 'nightstand', 'count', 'dresser', 'stool', 'cushion', 'grow in a garden', 'close the top of a room', 'bathtub', 'end table', 'dining table', 'type', 'bag', 'backpack', 'blow your nose',
        'print documents', 'tv stand', 'whiteboard', 'cover a bed', 'shower curtain', 'trash can', 'closet', 'stairs', 'microwave', 'stove', 'foot protection', 'computer tower', 'bottle', 'bin', 'put your feet on', 'bench', 'board', 'washing machine', 'see yourself', 'copier',
        'basket', 'sofa chair', 'file cabinet', 'cool a person', 'laptop', 'be a rainfall of short duration', 'make paper airplanes', 'person', 'paper towel dispenser', 'oven', 'blinds', 'rack', 'plate', 'blackboard', 'piano', 'suitcase', 'rail', 'radiator', 'collect recyclable plastics', 'container',
        'wardrobe', 'soap dispenser', 'communicate', 'bucket', 'set an alarm', 'stand', 'light', 'laundry basket', 'pipe', 'dry clothes', 'guitar', 'toilet paper holder', 'seat', 'make a captured voice become audible', 'hold up the roof', 'ride', 'ladder', 'bathroom stall', 'shower wall',
        'cup', 'jacket', 'storage bin', 'coffee maker', 'dishwasher', 'paper towel roll', 'machine', 'mat', 'windowsill', 'get drunk', 'making toast', 'bulletin board', 'ironing clothes', 'fireplace', 'hold soap', 'kitchen counter', 'doorframe',
        'dispen toilet paper', 'mini fridge', 'putting out fires', 'play a game', 'protect your head', 'shower curtain rod', 'water cooler', 'paper cutter', 'tray', ' keep the bathroom from getting wet', 'pillar', 'ledge', 'toaster oven', 'control a computer', 'toilet seat cover dispenser',
        'furniture', 'cart', 'storage container', 'measure weight', 'tissue box', 'turn on a light', 'crate', 'power outlet', 'decoration', 'sign', 'show movies', 'closet door', 'vacumming', 'candle', 'unblock a toilet', 'entertain a child', 'listen to music', 'dish rack',
        'sweeping', 'store guitar', 'range hood', 'dustpan', 'dry your hair', 'water bottle', 'handicap bar', 'carry money', 'vent', 'shower floor', 'water pitcher', 'receive letters', 'hold food', 'paper bag', 'awaken', 'hold sheet music', 'projector screen', 'divide things',
        'laundry detergent', 'bathroom counter', 'object', 'bathroom vanity', 'closet wall', 'storage dirty clothes', 'bathroom stall door', 'ceiling light', 'trash bin', 'dumbbell', 'stair rail', 'tube', 'bathroom cabinet', 'hold cd', 'hang clothes',
        'make coffee', 'structure', 'spray water', 'keyboard piano', 'case of water bottles', 'hang coat', 'storage organizer', 'folded chair', 'detect fire', 'power strip', 'mark that special date', 'decorate your room', 'potted plant', 'luggage', 'mattress')
